...
export const SAND: AppTheme = {
  name: "Sand",
  accent:            "#b84e14",
  leftPanelBg:       "rgb(235,219,178)",
  rightPanelBg:      "rgb(235,219,178)",
  footerBg:          "rgb(235,219,178)",
  headerBg:          "rgb(242,229,188)",
  mainBg:            "rgb(242,229,188)",
  cardBg:            "#ebdbb2",
  gridCardTextBg:    "#ebdbb2",
  textPrimary:       "#524f4c",
  ...
  fontWeightHero:      400,
  fontWeightEmphasis:  700,
  fontFamily:        "'Noto Sans', 'Inter Variable'",
  titleBarDark:      true,
};
